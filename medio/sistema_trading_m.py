# ==========================================================
# SISTEMA TRADING MEDIO PLAZO - VERSIÓN CORREGIDA
...
def evaluar_entrada_medio_plazo(precios, volumenes=None, fechas=None, df=None):
    ...
    try:
        ...
        if not datos_ibex.empty and len(datos_ibex) >= 200:
            ...
            # Guardar en detalles
            detalles["mercado_ibex"] = "ALCISTA" if precio_ibex_num > mm200_ibex_num else "BAJISTA"
            detalles["precio_ibex"] = round(precio_ibex_num, 2)
            detalles["mm200_ibex"] = round(mm200_ibex_num, 2)
            
            # ✅ Comparación segura
            if precio_ibex_num < mm200_ibex_num:
                return {
                    "decision": "NO_OPERAR",
