...
# generar_resumen_tecnico no existe en nueva arquitectura
...
def detectar_patrones_chartistas(df, lookback=100, ventana=7):
    ...
    try:
        ...
        for i in range(len(minimos_idx) - 1):
            ...
            # Solo filtrar por distancia si NO está confirmado
            # Un patrón confirmado siempre se muestra aunque el precio haya subido mucho
            if not confirmado and abs(precio_actual - precio2) / precio2 * 100 > 8.0:
                continue
