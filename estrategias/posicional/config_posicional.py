...
DISTANCIA_MAX_MM50_PCT     = 50.0   # Máximo 50% — solo bloquea sobreextensión extrema
...
CONTINUO_GRUPO_2 = [  # EBR → MEL
    "EBROM.MC", "ENO.MC", "FAE.MC", "GEST.MC",
    "GRE.MC", "HBX.MC", "HOME.MC",
    "LDA.MC", "MEL.MC"
]

CONTINUO_GRUPO_3 = [  # MVC → Z
    "MVC.MC", "OHLA.MC", "PHM.MC", "PSG.MC",
